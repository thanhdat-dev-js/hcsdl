        ...
        <form action="" method="POST">
            <div class="myform">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="ma" id="ma" require>
                </div>
                <div class="mb-3">
                    <label for="tac_gia" class="form-label">Thời gian bắt đầu hiệu lực</label>
                    <input type="date" class="form-control" name="thoi_gian_bat_dau_hieu_luc" id="thoi_gian_bat_dau_hieu_luc" require>
                </div>
                <div class="mb-3">
                    <label for="the_loai" class="form-label">Thời gian hết hiệu lực</label>
                    <input type="date" class="form-control" name="thoi_gian_het_hieu_luc" id="thoi_gian_het_hieu_luc" require>
                </div>
                <div class="mb-3">
                    <label for="gia_nhap" class="form-label">Mã đơn hàng</label>
                    <select class="form-select" name="ma_don_hang" require>
                        <?php
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" name="da_su_dung" id="da_su_dung" require>
                        <option value="false">Chưa sử dụng</option>
                        <option value="true">Đã sử dụng</option>
                    </select>
                </div>
                <button class="btn btn-primary" type="submit" name="btn_create">Thêm voucher mới</button>
            </div>
